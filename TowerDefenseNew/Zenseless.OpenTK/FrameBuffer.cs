...
namespace Zenseless.OpenTK
{
    ...
    public class FrameBuffer : Disposable, IObjectHandle
    {
        ...
        /// <returns></returns>
        public Texture GetTexture(FramebufferAttachment attachmentPoint)
        {
            return _attachedTextures[attachmentPoint];
        }
        ...
        public void Attach(Texture texture, FramebufferAttachment attachmentPoint)
        {
            ...
            static bool IsDrawBuffer(FramebufferAttachment a)
            {
                return Enum.IsDefined(typeof(DrawBuffersEnum), (int)a);
            }
