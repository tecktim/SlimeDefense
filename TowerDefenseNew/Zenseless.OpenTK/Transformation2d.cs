...
namespace Zenseless.OpenTK
{
    ...
    public static class Transformation2d
    {
        ...
        /// <param name="transformation">the transformation to apply</param>
        /// <returns></returns>
        public static Vector2 TransformDirection(this Vector2 input, Matrix4 transformation)
        {
            return Vector4.TransformRow(new Vector4(input.X, input.Y, 0f, 0f), transformation).Xy;
        }
    }
}
